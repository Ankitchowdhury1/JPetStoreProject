...
public class DogWithIcon{
	

	WebDriver driver;
	
	public DogWithIcon(WebDriver driver) {
		this.driver=driver;
	}
	By dog = By.xpath("//img[@src='../images/sm_dogs.gif']");//img[@src='../images/sm_dogs.gif']
	...
	By GoToDogIcon=By.xpath("//area[@alt='Dogs']");
	...
	public WebElement gotoDogIcon() {
		return driver.findElement(GoToDogIcon);
	}
